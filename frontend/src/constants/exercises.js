export const exercises = [
    // Chest Exercises
    {
      ...
      category: "chest",
      equipment: "barbell",
      image: "src/images/exercise-images/barbell-bench.png",
    ...
    },
    {
      ...
      category: "chest",
      equipment: "dumbbell",
      image: "src/images/exercise-images/incline-db-bench.webp",
      instructions: "Lie back on an incline bench with a dumbbell in each hand atop your thighs. The palms of your hands will be facing each other. Then, using your thighs to help push the dumbbells up, lift the dumbbells one at a time so that you can hold them at shoulder width. Once you have the dumbbells raised to shoulder width, rotate your wrists forward so that the palms of your hands are facing away from you. This will be your starting position. Be sure to keep full control of the dumbbells at all times. Then breathe out and push the dumbbells up with your chest. Lock your arms at the top, hold for a second, and then start slowly lowering the weight. "
    },
    {
      name: "Cable Crossover",
      category: "chest",
      equipment: "cable",
      image: "src/images/exercise-images/high-cable-fly.gif",
    ...
    },
    {
      ...
      image: "src/images/exercise-images/chest-dip.jpg",
    ...
    },
    {
      ...
      category: "chest",
      equipment: "dumbbell",
      image: "src/images/exercise-images/db-bench.webp",
    ...
    },
    {
      ...
      category: "chest",
      equipment: "machine",
      image: "src/images/exercise-images/machine-chess-press.jpg",
    ...
    },
    {
      ...
      category: "chest",
      equipment: "machine",
      image: "src/images/exercise-images/pec-deck.gif",
      instructions: "Sit on the machine, bring handles together in front of chest, then slowly return."
    },
    {
      name: "Incline Bench Press",
      category: "chest",
      equipment: "barbell",
      image: "src/images/exercise-images/incline-barbell-bench.png",
      instructions: "Lay on the bench with your feet flat on the ground, driving through to your hips. Your back should be arched, and your shoulder blades retracted. Take a medium, pronated grip covering the rings on the bar. Remove the bar from the rack, holding the weight above your chest with your arms extended. This will be your starting position. Lower the bar to the sternum by flexing the elbows. Maintain control and do not bounce the bar off of your chest. Your lats should stay tight and elbows slightly drawn in. After touching your torso with the bar, extend the elbows to return the bar to the starting position."
    },
    {
      name: "Incline Machine Chest Press",
      category: "chest",
      equipment: "machine",
      image: "src/images/exercise-images/incline-chest-press.gif",
      instructions: "The handles should be near the top of the pectorals at the beginning of the motion. Your chest and head should be up and your shoulder blades retracted. This will be your starting position. Press the handles forward by extending through the elbow. After a brief pause at the top, return the weight just above the start position, keeping tension on the muscles by not returning the weight to the stops until the set is complete."
    },
    ...
    // Back Exercises
    {
      ...
      category: "back",
      equipment: "bodyweight",
      image: "src/images/exercise-images/pull-up.webp",
    ...
    },
    {
      ...
      category: "back",
      equipment: "machine",
      image: "src/images/exercise-images/lat-pull-down.webp",
    ...
    },
    {
      ...
      category: "back",
      equipment: "barbell",
      image: "src/images/exercise-images/dead-lift.gif",
    ...
    },
    {
      ...
      category: "back",
      equipment: "cable",
      image: "src/images/exercise-images/cable-row.jpeg",
    ...
    },
    {
      ...
      category: "back",
      equipment: "barbell",
      image: "src/images/exercise-images/tbar-row.jpg",
    ...
    },
    {
      ...
      category: "back",
      equipment: "barbell",
      image: "src/images/exercise-images/bent-over-row.png",
    ...
    },
    {
      ...
      category: "back",
      equipment: "dumbbell",
      image: "src/images/exercise-images/single-arm-row.gif",
    ...
    },
    {
      ...
      category: "back",
      equipment: "cable",
      image: "src/images/exercise-images/face-pull.webp",
      instructions: "Set rope at upper chest height, pull toward face with elbows high."
    },
    {
      name: "Machine Row",
      category: "back",
      equipment: "bodyweight",
      image: "src/images/exercise-images/machine-row.webp",
      instructions: "Lie under a bar, grip it, and pull chest up to bar, keeping body straight."
    },
    ...
    },
    {
      ...
      category: "legs",
      equipment: "dumbbell",
      image: "src/images/exercise-images/hack-squat.gif",
    ...
    },
    {
      ...
      category: "legs",
      equipment: "barbell",
      image: "src/images/exercise-images/rdl.webp",
    ...
    },
    {
      ...
      category: "legs",
      equipment: "machine",
      image: "src/images/exercise-images/leg-curl.jpg",
      instructions: "Adjust the machine lever to fit your height and lie face down on the leg curl machine with the pad of the lever on the back of your legs (just a few inches under the calves. his will be your starting position. As you exhale, curl your legs up as far as possible without lifting the upper legs from the pad. Once you hit the fully contracted position, hold it for a second. As you inhale, bring the legs back to the initial position. Repeat for the recommended amount of repetitions."
    },
    {
      name: "Leg Extension",
      category: "legs",
      equipment: "machine",
      image: "src/images/exercise-images/leg-extension.gif",
      instructions: "For this exercise you will need to use a leg extension machine. First choose your weight and sit on the machine with your legs under the pad (feet pointed forward and the hands holding the side bars. This will be your starting position. Using your quadriceps, extend your legs to the maximum as you exhale. Ensure that the rest of the body remains stationary on the seat. Pause a second on the contracted position. Slowly lower the weight back to the original position as you inhale, ensuring that you do not go past the 90-degree angle limit."
    },
    {
      name: "Bulgarian Split Squat",
      category: "legs",
      equipment: "dumbbell",
      image: "src/images/exercise-images/splits.webp",
      instructions: "Move one foot back so that your toe is resting on the flat bench. Your other foot should be stationary in front of you. Keep your head up at all times as looking down will get you off balance and also maintain a straight back. As you inhale, slowly lower your leg until your thigh is parallel to the floor. At this point, your knee should be over your toes. Your chest should be directly above the middle of your thigh. Leading with the chest and hips and contracting the quadriceps, elevate your leg back to the starting position as you exhale."
    },
    {
      name: "Goblet Squat",
      category: "legs",
      equipment: "dumbbell",
      image: "src/images/exercise-images/goblet.jpg",
      instructions: "From a standing position cradle the head of a dumbbell close to your chest with both hands. You should be looking straight forward, with your shoulders back, your spine straight, and your feet just outside of shoulder width. This will be your starting position. Initiate the movement by descending into a squat, flexing the hips and knees to lower your body. Maintain the angle of your torso, paying close attention to the preservation of your spine. As you descend, push your knees outward and keep your weight on your heels. Descend until you either reach the full squat position with your hamstrings on your calves or until your back starts to round. At the bottom of the motion pause briefly. Return to the starting position by driving through your heels, extending the knees and hips to return to the starting position. "
    },
    {
      name: "Hip Thrust",
      category: "legs",
      equipment: "dumbbell",
      image: "src/images/exercise-images/hip-thrust.webp",
    ...
    },
    {
      ...
      category: "legs",
      equipment: "bodyweight",
      image: "src/images/exercise-images/calves.jpg",
      instructions: "Stand and lift heels off floor, then lower slowly."
    },
    ...
    // Abs Exercises
    {
      ...
      category: "abs",
      equipment: "bodyweight",
      image: "src/images/exercise-images/crunch.gif",
      instructions: "Lie on back, lift shoulders off floor by contracting abs."
    },
    {
      name: "Plank",
      category: "abs",
      equipment: "bodyweight",
      image: "src/images/exercise-images/plank.jpg",
    ...
    },
    {
      ...
      category: "abs",
      equipment: "dumbbell",
      image: "src/images/exercise-images/russian-twist.webp",
    ...
    },
    {
      ...
      image: "src/images/exercise-images/hanging-leg-raise.webp",
    ...
    },
    {
      ...
      category: "abs",
      equipment: "bodyweight",
      image: "src/images/exercise-images/bicycle-crunch.gif",
    ...
    },
    {
      ...
      category: "abs",
      equipment: "bodyweight",
      image: "src/images/exercise-images/v-up.gif",
      instructions: "Lie flat on the floor (or exercise mat on your back with your arms extended straight back behind your head and your legs extended also. This will be your starting position. As you exhale, bend at the waist while simultaneously raising your legs and arms to meet in a jackknife position."
    },
    {
      name: "Ab Rollout",
      category: "abs",
      equipment: "ab wheel",
      image: "src/images/exercise-images/ab-roll-out.jpg",
      instructions: "Hold the Ab Roller with both hands and kneel on the floor. Now place the ab roller on the floor in front of you so that you are on all your hands and knees (as in a kneeling push up position. This will be your starting position. Slowly roll the ab roller straight forward, stretching your body into a straight position. Breathe in during this portion of the movement. After a pause at the stretched position, start pulling yourself back to the starting position as you breathe out. Tip: Go slowly and keep your abs tight at all times."
    },
    ...
    // Biceps Exercises
    {
      ...
      category: "biceps",
      equipment: "barbell",
      image: "src/images/exercise-images/straight-bar-curl.webp",
      instructions: "Stand up with your torso upright while holding a barbell at a shoulder-width grip. The palm of your hands should be facing forward and the elbows should be close to the torso. This will be your starting position. While holding the upper arms stationary, curl the weights forward while contracting the biceps as you breathe out. Continue the movement until your biceps are fully contracted and the bar is at shoulder level. Hold the contracted position for a second and squeeze the biceps hard. Slowly begin to bring the bar back to starting position as your breathe in. Repeat for the recommended amount of repetitions."
    },
    {
      name: "Dumbbell Curl",
      category: "biceps",
      equipment: "dumbbell",
      image: "src/images/exercise-images/db-curl.gif",
      instructions: "Hold dumbbells at sides, curl to shoulders, and lower."
    },
    {
      name: "Hammer Curl",
      category: "biceps",
      equipment: "dumbbell",
      image: "src/images/exercise-images/hammer-curl.webp",
    ...
    },
    {
      ...
      category: "biceps",
      equipment: "machine",
      image: "src/images/exercise-images/preacher-curl.webp",
    ...
    },
    {
      ...
      category: "biceps",
      equipment: "cable",
      image: "src/images/exercise-images/cable-curl.webp",
    ...
    },
    {
      ...
      category: "biceps",
      equipment: "dumbbell",
      image: "src/images/exercise-images/c-curl.webp",
      instructions: "Sit down on a flat bench with one dumbbell in front of you between your legs. Your legs should be spread with your knees bent and feet on the floor. Use your right arm to pick the dumbbell up. Place the back of your right upper arm on the top of your inner right thigh. Rotate the palm of your hand until it is facing forward away from your thigh. This will be your starting position. While holding the upper arm stationary, curl the weights forward while contracting the biceps as you breathe out. Only the forearms should move. Continue the movement until your biceps are fully contracted and the dumbbells are at shoulder level. Slowly begin to bring the dumbbells back to starting position as your breathe in. Caution: Avoid swinging motions at any time. Repeat for the recommended amount of repetitions."
    },
    {
      name: "EZ-Bar Curl",
      category: "biceps",
      equipment: "barbell",
      image: "src/images/exercise-images/barbell-curl.webp",
    ...
    },
    {
      ...
      category: "biceps",
      equipment: "dumbbell",
      image: "src/images/exercise-images/incline-curl.jpg",
    ...
    },
    {
      ...
      category: "biceps",
      equipment: "Machine",
      image: "src/images/exercise-images/machine-curl.webp",
    ...
    // Triceps Exercises
    {
      ...
      category: "triceps",
      equipment: "cable",
      image: "src/images/exercise-images/triceps-pushdown.jpg",
    ...
    },
    {
      ...
      category: "triceps",
      equipment: "barbell",
      image: "src/images/exercise-images/skull-crusher.jpg",
      instructions: "Using a close grip, lift the EZ bar and hold it with your elbows in as you lie on the bench. Your arms should be perpendicular to the floor. This will be your starting position. Keeping the upper arms stationary, lower the bar by allowing the elbows to flex. Inhale as you perform this portion of the movement. Pause once the bar is directly above the forehead. Lift the bar back to the starting position by extending the elbow and exhaling."
    },
    {
      name: "Overhead Dumbbell Extension",
      category: "triceps",
      equipment: "dumbbell",
      image: "src/images/exercise-images/overhead-db.gif",
      instructions: "Hold dumbbell overhead, lower behind head and extend."
    },
    {
      name: "Close-Grip Bench Press",
      category: "triceps",
      equipment: "barbell",
      image: "src/images/exercise-images/close-grip.gif",
    ...
    },
    {
      ...
      category: "triceps",
      equipment: "dumbbell",
      image: "src/images/exercise-images/kickbacks.webp",
    ...
    },
    {
      ...
      category: "triceps",
      equipment: "cable",
      image: "src/images/exercise-images/cable-overhead.gif",
      instructions: "Face away from pulley, extend arms overhead."
    },
    {
      name: "Machine Dips",
      category: "triceps",
      equipment: "machine",
      image: "src/images/exercise-images/mc-dips.jpeg",
      instructions: "Sit securely in a dip machine, select the weight and firmly grasp the handles. Now keep your elbows in at your sides in order to place emphasis on the triceps. The elbows should be bent at a 90 degree angle. As you contract the triceps, extend your arms downwards as you exhale. Now slowly let your arms come back up to the starting position as you inhale. Repeat for the recommended amount of repetitions."
    },
    {
      name: "Triceps Extension",
      category: "triceps",
      equipment: "bodyweight",
      image: "src/images/exercise-images/single-arm-triceps.webp",
      instructions: "With your right hand, grasp a single handle attached to the high-cable pulley using a supinated (underhand; palms facing up grip. You should be standing directly in front of the weight stack. Now pull the handle down so that your upper arm and elbow are locked in to the side of your body. Your upper arm and forearm should form an acute angle (less than 90-degrees. You can keep the other arm by the waist and you can have one leg in front of you and the other one back for better balance. This will be your starting position. As you contract the triceps, move the single handle attachment down to your side until your arm is straight. Breathe out as you perform this movement. "
    },
    {
      name: "Rope Triceps Extension",
      category: "triceps",
      equipment: "resistance band",
      image: "src/images/exercise-images/rope-triceps.jpg",
    ...
    },
    {
      ...
      category: "shoulders",
      equipment: "dumbbell",
      image: "src/images/exercise-images/lateral-raise.webp",
    ...
    },
    {
      ...
      category: "shoulders",
      equipment: "dumbbell",
      image: "src/images/exercise-images/front-raise.webp",
    ...
    },
    {
      ...
      category: "shoulders",
      equipment: "dumbbell",
      image: "src/images/exercise-images/rear-raise.jpg",
      instructions: "Raise dumbbells upwards, contracting the shoulder blades, then lower."
    },
    {
      name: "Cable Lateral Raise",
      category: "shoulders",
      equipment: "dumbbell",
      image: "src/images/exercise-images/cable-lat-raise.webp",
      instructions: "Raise cable to side until shoulder height, then lower."
    },
    {
      name: "Shoulder Press Machine",
      category: "shoulders",
      equipment: "dumbbell",
      image: "src/images/exercise-images/shoulder-press-machine.jpg",
    ...
    },
    {
      ...
      category: "shoulders",
      equipment: "dumbbell",
      image: "src/images/exercise-images/lat-raise-machine.webp",
